...
class SignUp extends Component {
  ...
  render() {
    const { email, password, repassword,onsubmit,checkbox} = this.state;
    return (
            ...
            <div className='form-container'>
              ...
              <form className='form' onSubmit={(e)=>this.props.onSubmit(e,email,password,repassword,checkbox)}>
                ...
                <Input
                  ...
                  onChange={this.onChange}
                />
                <Checkbox checkbox={this.state.checkbox}  onChange={this.onChange}/>
                <Button content={'Register Account'} classname={'submit'} type={'submit'} />
